...
4. Импортируйте репозиторий `ctrl111/FlightDeals-front`
5. Vercel автоматически определит Next.js и настроит конфигурацию
6. Нажмите "Deploy"
7. Готово! Ваш сайт будет доступен по адресу `https://your-project.vercel.app`
...
После первого развёртывания, каждый push в ветку `main` будет автоматически развёртывать новую версию на Vercel.
